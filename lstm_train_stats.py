...
def main(args):
        ...
        for i in range(0, args.reps):
            ...
            f1, acc = trainer.train(LSTMCRF, x_train, y_train, x_valid=x_valid, y_valid=y_valid, save=False, label_map=label_map, epochs=args.epochs, train_batch_size=args.train_batch_size, output_dir=args.output_dir,
